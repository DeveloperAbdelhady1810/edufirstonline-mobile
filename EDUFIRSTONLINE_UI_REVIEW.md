...
- [ ] Flagship screen (Step 4) reviewed and approved before other screens were built — **built, screenshots sent, awaiting your sign-off**
...
- [x] At least one Lottie animation used somewhere appropriate — used on the login screen header. **This specific animation is a placeholder** (a generic "smile" character, verified working but not education-themed or brand-chosen) — swap for a real pick before shipping.
